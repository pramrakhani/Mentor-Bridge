...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-400/10 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-4 p-3 bg-blue-50 text-blue-700 rounded-lg text-sm">
            <strong>First time?</strong> You need to create an account first. Click "Sign up" below or use Google Sign-In.
          </div>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full py-3 border border-neutral-200 rounded-lg font-semibold hover:bg-neutral-50 transition disabled:opacity-50 flex items-center justify-center space-x-2"
            >
